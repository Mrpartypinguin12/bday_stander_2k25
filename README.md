# Hey Stander, It's Your Birthday!

Complete the following puzzles to reveal the secret message. 🎉

## Usage Instructions

This is an interactive birthday puzzle page. To use it:

1. Save the following HTML code as `index.html` in your project.
2. Open the `index.html` file in your web browser.
3. Add your own images by replacing `left-image.jpg` and `right-image.jpg` with the paths to your desired pictures.
4. Solve the puzzles in order to unlock the secret message.
